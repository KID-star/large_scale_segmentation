from myhelper_tool import DataProcessing as DP
# from myhelper_tool import ConfigS3DIS as cfg
...
class My_data(Dataset):
    def __init__(self, test_area_idx=4):
        self.name = 'Car'
        self.path = 'data'
        self.label_to_names = {0: 'crown',
                               1: 'trunk',
                               2: 'pot',
                               3: 'pole',
                               4: 'ground',
        ...
        cfg.class_weights = DP.get_class_weights('Car')
        cfg.name = 'Car'

        # self.val_split = 'Area_' + str(test_area_idx)  # 哪个区域作为验证集
        self.val_split = 'out_'+ str(test_area_idx)+'_'+'Area_' + str(test_area_idx)  # 哪个区域作为验证集
